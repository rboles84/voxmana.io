...
| Already-hidden backgrounds and Home philosophy strip | Preserve current accepted state | Avoid losing prior visual work or reopening unrelated presentation scope | VM-634/635 already changed public visibility. Old image assets remain in the repository and may remain directly addressable. VM-656 separately removes the retired Terminal/account runtime rather than preserving it as hidden or future-ready. |
