...
test('agent model routing requires explicit focused delegation and transparent capability gaps', () => {
  ...
  assert.match(routing, /After spawn and in the compact handoff[\s\S]*?accepted\/requested configuration[\s\S]*?host-confirmed settings/i);
  assert.match(routing, /Distinguish requested arguments, host confirmation, and backend telemetry/i);
