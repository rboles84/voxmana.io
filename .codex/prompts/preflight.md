...
Use [Agent Model Routing](../../docs/reference/token-reasoning-cost-control.md#agent-model-routing): preflight uses the current coordinator/session context; this prompt does not select a model itself.
